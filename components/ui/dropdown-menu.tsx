...
// Non-modal by default: a modal menu marks every other element aria-hidden when it opens and
// restores them when it closes, which takes about a second next to a large result grid. Outside
// clicks and Escape still close it.
...
function DropdownMenuSubContent({
  ...
  // Portalled like DropdownMenuContent: rendered inside the parent menu it would be clipped by the
  // parent's scroll container (its transform animation also traps position: fixed children)
  return (
    <DropdownMenuPrimitive.Portal>
